...
This project lives inside the `pebble` repository at `projects/backfire/`, which is where
projects built there are kept. It is self-contained and moves unchanged if extracted.
